...
\shorterSection{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {BA in Physics and Astrophysics;  GPA: 3.958/4.0}{Expected May 2022}{
    }
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeSubheading
        ...
        \resumeItemListEnd
     \resumeSubheading
        {LIGO Summer Undergraduate Research Fellowship}{June 2020 - August 2020}{California Institute of Technology}{}
        \resumeItemListStart
        ...
        \resumeItemListEnd
    \resumeSubheading
        {ULAB Computational Astrophysics Project}{September 2019- May 2020}{Position of ULAB Mentee}{}
        \resumeItemListStart
    ...
    \resumeSubheading
        {Intro to Astro Research Summer Workshop}{}
        {Workshop during Summer 2019}{}
        \resumeItemListStart
            \resumeItem{Topics}
    ...
    \resumeSubheading
      {Intro to Computational Physics Final Project}{}
      {We programmed a virtual simulation of a pool game in Python}{}
      \resumeItemListStart
...
\shorterSection{Skills}
  ...
  \small
    \item{
     \textbf{Programming Languages}{: Python, UNIX, Java, C++, HTML, Javascript, CSS}
    }
    \vspace{-5pt}
    \item{
     \textbf{Technologies}{: GitHub, Adobe Illustrator, Adobe Photoshop, Adobe Premier Pro, Microsoft Office Programs, Google Drive}
    }
    \vspace{-5pt}
    \item{
     \textbf{Libraries}{: Numpy, Pandas, Jupyter, PyGame, MatPlotlib, SciPy, yt | Athena++}
    }
    \vspace{-5pt}
    \item{
...
\resumeSubheading
  ...
  \begin{itemize}
     ...
     \item Helped plan and teach several summer camps for the past two years. \textit{Astronaut Training, Science Wizards, Science Detectives, Terrific Tinkering, etc...}
